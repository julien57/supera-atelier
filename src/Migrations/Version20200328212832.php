 ...
 */
final class Version20200328212832 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD order_number VARCHAR(20) NOT NULL');
        $this->addSql('ALTER TABLE event CHANGE note note DOUBLE PRECISION DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP order_number');
    }
}
