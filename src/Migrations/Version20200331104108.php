 ...
 */
final class Version20200331104108 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE page ADD mentions LONGTEXT DEFAULT NULL, ADD cgv LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE page DROP mentions, DROP cgv');
    }
}
