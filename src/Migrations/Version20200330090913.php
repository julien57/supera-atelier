 ...
 */
final class Version20200330090913 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gift_amount ADD event_id INT DEFAULT NULL, CHANGE code code VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE gift_amount ADD CONSTRAINT FK_D207321671F7E88B FOREIGN KEY (event_id) REFERENCES event (id)');
        $this->addSql('CREATE INDEX IDX_D207321671F7E88B ON gift_amount (event_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gift_amount DROP FOREIGN KEY FK_D207321671F7E88B');
        $this->addSql('DROP INDEX IDX_D207321671F7E88B ON gift_amount');
        $this->addSql('ALTER TABLE gift_amount DROP event_id, CHANGE code code VARCHAR(13) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
