 ...
 */
final class Version20200330115133 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD umber_gift_card VARCHAR(13) DEFAULT NULL, DROP is_gift_card');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD is_gift_card TINYINT(1) NOT NULL, DROP umber_gift_card');
    }
}
