 ...
 */
final class Version20200331095324 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE page (id INT AUTO_INCREMENT NOT NULL, presentation LONGTEXT DEFAULT NULL, valeurs LONGTEXT DEFAULT NULL, avantages_atelier LONGTEXT DEFAULT NULL, quipeutdeposer LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
