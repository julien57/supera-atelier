 ...
 */
final class Version20200330114629 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD is_gift_card TINYINT(1) NOT NULL, DROP gift_card');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD gift_card INT DEFAULT NULL, DROP is_gift_card');
    }
}
